...
$knowledgeBases = [];
try {
    $knowledgeBases = $db->fetchAll("SELECT id, name, description FROM knowledge_bases WHERE status = 'active' ORDER BY created_at DESC");
} catch (Exception $e) {
    // 表不存在时返回空数组
    $knowledgeBases = [];
}
...
<head>
    ...
    <title><?php echo $agent ? '编辑智能体' : '创建智能体'; ?> - 巨神兵API辅助平台API辅助平台</title>
                    ...
                    <div class="tab-content" id="tab-role">
                        ...
                        <div class="form-group">
                            ...
                            <div class="empty-state">
                                ...
                                <p>暂无可用知识库</p>
                                <a href="?route=knowledge" style="color: #4c51bf; font-size: 12px;">前往创建</a>
                            </div>
                            <?php else: 
