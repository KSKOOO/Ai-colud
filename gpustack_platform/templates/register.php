...
<head>
    ...
    <meta name="description" content="巨神兵API辅助平台API辅助平台 - 用户注册">
    <title>巨神兵API辅助平台API辅助平台 - 注册</title>
...
<body>
    <div class="container">
        <div class="register-container">
            <div class="register-card">
                <div class="register-header">
                    <div class="logo">
                        <img src="../assets/images/logo.png" alt="巨神兵API辅助平台API辅助平台" style="height: 50px;">
                    </div>
                    <h2>创建新账户</h2>
                    <p style="color: #666; font-size: 16px;">加入巨神兵API辅助平台API辅助平台大家庭</p>
                </div>
        ...
        <footer class="footer">
            <p>&copy; <?php echo date('Y'); ?> 巨神兵API辅助平台API辅助平台. All rights reserved.</p>
        </footer>
    </div>
