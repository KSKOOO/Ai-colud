...
<head>
    ...
    <title>关于 - 巨神兵API辅助平台API辅助平台</title>
    ...
    <div class="container">
        ...
        <header class="header">
            <a href="?route=home" class="logo" style="text-decoration: none; display: flex; align-items: center; gap: 10px; min-width: 240px; flex-shrink: 0;">
                <img src="assets/images/logo.png" alt="巨神兵API辅助平台AI" style="height: 32px; width: auto; flex-shrink: 0;" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                <span style="display: flex; align-items: center; gap: 8px; color: #4c51bf; white-space: nowrap;">
                    <span style="font-size: 18px; font-weight: 700; white-space: nowrap;">巨神兵API辅助平台API辅助平台</span>
                </span>
            </a>
        ...
        <!-- 主内容 -->
        <div class="main-card">
            <h1 class="page-title">关于巨神兵API辅助平台API辅助平台</h1>
            
            <div class="about-content">
                <p>巨神兵API辅助平台API辅助平台是一个基于先进AI技术的智能服务平台，致力于为用户提供强大的AI能力，助力工作效率提升。</p>
                ...
                <div class="contact-section">
                    ...
                    <p><i class="fas fa-envelope" style="margin-right: 8px;"></i> 1293724438@qq.com</p>
                     <p><i class="fas fa-envelope" style="margin-right: 8px;"></i> 巨神兵API辅助平台出品</p>
                </div>
            </div>
        </div>
    </div>
