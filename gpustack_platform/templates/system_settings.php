...
$settings = [
    'general' => [
        ...
        'icon' => 'fa-cog',
        'items' => [
            ['key' => 'app_name', 'label' => '平台名称', 'type' => 'text', 'value' => $config['app']['name'] ?? '巨神兵API辅助平台API辅助平台'],
...
<head>
    ...
    <title>系统设置 - <?php echo $config['app']['name'] ?? '巨神兵API辅助平台API辅助平台'; ?></title>
...
<body>
    ...
    <header class="top-nav">
        <a href="?route=home" class="logo">
            <i class="fas fa-robot"></i> <?php echo $config['app']['name'] ?? '巨神兵API辅助平台API辅助平台'; ?>
        </a>
        <nav class="nav-links">
