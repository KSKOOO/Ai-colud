    ...
    <div class="container">
        ...
        <header class="header">
            <a href="?route=home" class="logo" style="text-decoration: none; display: flex; align-items: center; gap: 10px;">
                <img src="assets/images/logo.png" alt="巨神兵AIAI" style="height: 32px;" onerror="this.style.display='none';">
                <span style="color: #4c51bf;">巨神兵AIAPI辅助平台</span>
            </a>
            <nav class="nav">
        ...
        <div class="main-content">
            ...
            <div class="section">
                ...
                <div class="section-content">
                    <p>欢迎使用巨神兵AIAPI辅助平台！请您在使用本平台前仔细阅读本用户协议（以下简称"本协议"）。通过下载、安装、注册或使用本平台，即表示您已阅读、理解并同意接受本协议的所有条款。如果您不同意本协议的任何内容，请立即停止使用本平台。</p>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="section-content">
                    <p>巨神兵AIAPI辅助平台是一款基于人工智能技术的智能服务平台，提供以下服务：</p>
                    <ul>
                        <li>AI智能对话和问答</li>
                        <li>文本生成和内容创作</li>
                        <li>代码辅助和编程支持</li>
            ...
            <div class="section">
                ...
                <div class="section-content">
                    <p>5.1 本平台的界面设计、代码、文档等知识产权归巨神兵AI有限公司所有。</p>
